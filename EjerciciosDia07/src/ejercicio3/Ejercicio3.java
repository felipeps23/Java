...
public class Ejercicio3 {
	// Ejercicio 3
	// Crear una tabla bidimensional de tamaño 3x3 y rellenarla de la siguiente forma: la posición        
	...
	public static void main(String[] args) {
        ...
        for (int i = 0; i < tabla.length; i++) {//Dimensión Uno.
            for (int j = 0; j < tabla.length; j++) {//Dimensión Dos.
            	tabla[i][j] = i + j;              
            }            
        }
