...
public class Ejercicio7 {
	...
	public static void main(String[] args) {
		// Ejercicio 7
		// Utilizando HashMap para ingresar al menos 5 países con sus respectivas capitales luego 
		// mostrar por pantalla. Y me de la opción se buscar valor según Clave desplegada por 
		// pantalla 
		...
		String deseo;
		System.out.println("La capital de qué pais desea ver?");
